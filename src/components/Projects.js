...
const Projects = () => {
  ...
  return (
    <div className="p-4 bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl shadow-xl">
      <h2 className="text-xl font-bold text-white mb-4">My Projects</h2>
      <div className="space-y-3">
        {projects.map((project, index) => (
          <div
            key={index}
            className="bg-gray-800 rounded-lg p-3 hover:transform hover:scale-[1.01] transition-all duration-300 shadow-lg border border-gray-700"
          >
