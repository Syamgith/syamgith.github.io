...
const Projects = () => {
  ...
  return (
    <div className="p-6 bg-gray-800/50 backdrop-blur-sm rounded-xl shadow-xl border border-gray-700/50">
      ...
      <div className="grid gap-4">
        {projects.map((project, index) => (
          <div
            key={index}
            className="group relative bg-gray-800/50 rounded-lg p-4 hover:transform hover:scale-[1.02] transition-all duration-300 border border-gray-700/50 hover:border-purple-500/50"
          >
            <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-600 to-pink-600 rounded-lg blur opacity-0 group-hover:opacity-25 transition duration-1000 group-hover:duration-200"></div>
                      ...
                      {project.playStoreLink && (
                        ...
                        >
                          <svg
                            ...
                            viewBox="0 0 24 24"
                          >
                            <path d="M3.609 1.814L13.792 12 3.609 22.186c-.646-.646-.646-1.692 0-2.338L11.454 12 3.609 4.152c-.646-.646-.646-1.692 0-2.338zm16.782 0c.646.646.646 1.692 0 2.338L12.546 12l7.845 7.848c.646.646.646 1.692 0 2.338L13.792 12l6.599-6.599c.646-.646.646-1.692 0-2.338z" />
                          </svg>
                        </a>
                      )}
                    </div>
